...
* Author: Keer Wang
* Purpose: demonstrate vulnerable vs secure input handling
*/
...
int main(void) {
    ...
    while (1) {
        ...
        if (vulnerable_mode) {
            ...
            change_pin_vulnerable(user_index,
                                  user_data.user_pin,
                                  new_pin);
        } else {
...
void change_pin_vulnerable(int user_i,
                           unsigned short u_pin[],
                           int new_pin) {
    /* no bounds checking */
...
bool change_pin_more_secure(int user_i,
                            unsigned short u_pin[],
                            int new_pin) {
